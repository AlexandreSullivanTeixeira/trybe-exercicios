...
WHERE adress_id IN(172,173,174,175,176)
ORDER BY email ASC;
...
5 Monte um relatório que exiba o título e classificação dos 500 primeiros filmes direcionados para as classificações
